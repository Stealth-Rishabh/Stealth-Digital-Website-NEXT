        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
              Building Authentic Influencer Partnerships That Convert
            </h2>
            
            {/* Description */}
            <p className="text-lg text-gray-600 leading-relaxed">
              We create genuine influencer relationships that build trust, drive engagement, and deliver measurable business results.
            </p>
...
export default InfluencerQualityFocus;
