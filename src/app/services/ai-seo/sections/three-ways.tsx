...
const AISEOThreeWays = () => {
  const steps = [
    {
      number: "01",
      title: "AI Analysis & Strategy Development",
    ...
    {
      number: "03",
      title: "AI-Powered Optimization & Monitoring", 
      bgColor: "bg-teal-100",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">
              Implement AI SEO In 3 Steps
            </h2>
            
            {/* Description */}
            <p className="text-lg text-gray-600 leading-relaxed">
              From AI analysis to automated optimization, we leverage cutting-edge technology for superior SEO results
            </p>
