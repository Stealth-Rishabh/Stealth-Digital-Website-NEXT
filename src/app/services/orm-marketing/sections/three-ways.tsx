...
const ORMThreeWays = () => {
  const steps = [
    {
      number: "01",
      title: "Reputation Assessment & Monitoring",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">
              Manage Your Reputation In 3 Steps
            </h2>
            
            {/* Description */}
            <p className="text-lg text-gray-600 leading-relaxed">
              From assessment to optimization, we protect and enhance your online reputation across all platforms
            </p>
